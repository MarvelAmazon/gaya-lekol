package com.gayahaiti.dev.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("gayaLekol");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("gayaLekol");
        ...
        config.getMapConfigs().put("com.gayahaiti.dev.domain.*", initializeDomainMapConfig(jHipsterProperties));
